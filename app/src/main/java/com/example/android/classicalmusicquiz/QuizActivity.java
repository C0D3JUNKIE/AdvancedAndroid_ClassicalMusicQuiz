...
// COMPLETE (1): Have this Activity implement ExoPlayer.EventListener and add the required methods.
  ...
  private int[] mButtonIDs = {R.id.buttonA, R.id.buttonB, R.id.buttonC, R.id.buttonD};
    ...
    private void initializePlayer(Uri mediaUri) {
        if (mExoPlayer == null) {
            ...
            // COMPLETE (2): Set the ExoPlayer.EventListener to this activity
    ...
    // COMPLETE (3): Add conditional logging statements to the onPlayerStateChanged() method that log when ExoPlayer is playing or paused.
    @Override
